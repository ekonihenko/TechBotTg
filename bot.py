...
TERMS_DATABASE = [
    ...
    {'en': 'repository', 'ru': 'репозиторий, хранилище', 'example_en': 'Create a new repository for your project', 'example_ru': 'Создайте новый репозиторий для вашего проекта'},
{'en': 'commit', 'ru': 'фиксация, коммит; фиксировать изменения', 'example_en': 'Commit your changes with a clear message', 'example_ru': 'Зафиксируйте изменения с понятным сообщением'},
{'en': 'branch', 'ru': 'ветка, ответвление', 'example_en': 'Create a new branch for the feature', 'example_ru': 'Создайте новую ветку для функции'},
{'en': 'merge', 'ru': 'слияние, объединение; сливать', 'example_en': 'Merge the feature branch into main', 'example_ru': 'Слейте ветку функции в основную'},
{'en': 'clone', 'ru': 'клонировать, копировать', 'example_en': 'Clone the repository to your computer', 'example_ru': 'Клонируйте репозиторий на свой компьютер'},
{'en': 'push', 'ru': 'отправлять, выталкивать', 'example_en': 'Push your commits to the remote server', 'example_ru': 'Отправьте свои коммиты на удалённый сервер'},
{'en': 'pull', 'ru': 'получать, вытягивать', 'example_en': 'Pull the latest changes from the server', 'example_ru': 'Получите последние изменения с сервера'},
{'en': 'fetch', 'ru': 'извлекать, забирать', 'example_en': 'Fetch updates without merging them', 'example_ru': 'Извлеките обновления без их слияния'},
{'en': 'checkout', 'ru': 'переключаться, извлекать', 'example_en': 'Checkout the development branch', 'example_ru': 'Переключитесь на ветку разработки'},
{'en': 'stage', 'ru': 'индексировать, подготавливать', 'example_en': 'Stage the files before committing', 'example_ru': 'Подготовьте файлы перед коммитом'},
{'en': 'unstage', 'ru': 'убрать из индекса, отменить подготовку', 'example_en': 'Unstage the file if you added it by mistake', 'example_ru': 'Уберите файл из индекса, если добавили по ошибке'},
{'en': 'stash', 'ru': 'прятать, откладывать; тайник', 'example_en': 'Stash your changes before switching branches', 'example_ru': 'Спрячьте изменения перед переключением веток'},
{'en': 'revert', 'ru': 'откатывать, возвращать', 'example_en': 'Revert the last commit to undo changes', 'example_ru': 'Откатите последний коммит для отмены изменений'},
{'en': 'reset', 'ru': 'сбрасывать, обнулять', 'example_en': 'Reset the branch to a previous state', 'example_ru': 'Сбросьте ветку к предыдущему состоянию'},
{'en': 'restore', 'ru': 'восстанавливать', 'example_en': 'Restore the deleted file from history', 'example_ru': 'Восстановите удалённый файл из истории'},
{'en': 'diff', 'ru': 'различие, разница', 'example_en': 'Show the diff between two commits', 'example_ru': 'Покажите различия между двумя коммитами'},
{'en': 'log', 'ru': 'журнал, история', 'example_en': 'Check the log to see commit history', 'example_ru': 'Проверьте журнал, чтобы увидеть историю коммитов'},
{'en': 'status', 'ru': 'статус, состояние', 'example_en': 'Check the status of your working directory', 'example_ru': 'Проверьте статус вашей рабочей директории'},
{'en': 'remote', 'ru': 'удалённый', 'example_en': 'Add a remote repository URL', 'example_ru': 'Добавьте URL удалённого репозитория'},
{'en': 'origin', 'ru': 'источник, происхождение', 'example_en': 'Origin is the default remote name', 'example_ru': 'Origin — это имя удалённого репозитория по умолчанию'},
{'en': 'upstream', 'ru': 'вышестоящий, исходный', 'example_en': 'Set upstream branch for tracking', 'example_ru': 'Установите вышестоящую ветку для отслеживания'},
{'en': 'downstream', 'ru': 'нижестоящий, производный', 'example_en': 'Changes flow downstream to forks', 'example_ru': 'Изменения передаются в производные форки'},
{'en': 'fork', 'ru': 'ответвление, форк; создать копию', 'example_en': 'Fork the repository to your account', 'example_ru': 'Создайте форк репозитория в свой аккаунт'},
{'en': 'tag', 'ru': 'метка, тег', 'example_en': 'Create a tag for the release version', 'example_ru': 'Создайте тег для версии релиза'},
{'en': 'head', 'ru': 'указатель на текущий коммит', 'example_en': 'HEAD points to the current commit', 'example_ru': 'HEAD указывает на текущий коммит'},
{'en': 'detached', 'ru': 'отсоединённый, отделённый', 'example_en': 'You are in detached HEAD state', 'example_ru': 'Вы находитесь в состоянии отсоединённого HEAD'},
{'en': 'tracked', 'ru': 'отслеживаемый', 'example_en': 'Only tracked files will be committed', 'example_ru': 'Только отслеживаемые файлы будут закоммичены'},
{'en': 'untracked', 'ru': 'неотслеживаемый', 'example_en': 'Untracked files are not in the repository', 'example_ru': 'Неотслеживаемые файлы не находятся в репозитории'},
{'en': 'staged', 'ru': 'проиндексированный, подготовленный', 'example_en': 'Staged files are ready for commit', 'example_ru': 'Проиндексированные файлы готовы к коммиту'},
{'en': 'modified', 'ru': 'изменённый', 'example_en': 'Modified files need to be staged', 'example_ru': 'Изменённые файлы нужно проиндексировать'},
{'en': 'conflict', 'ru': 'конфликт', 'example_en': 'Resolve the merge conflict manually', 'example_ru': 'Разрешите конфликт слияния вручную'},
{'en': 'resolve', 'ru': 'разрешать, решать', 'example_en': 'Resolve all conflicts before merging', 'example_ru': 'Разрешите все конфликты перед слиянием'},
{'en': 'rebase', 'ru': 'перебазировать', 'example_en': 'Rebase your branch onto main', 'example_ru': 'Перебазируйте вашу ветку на main'},
{'en': 'squash', 'ru': 'сжимать, объединять коммиты', 'example_en': 'Squash multiple commits into one', 'example_ru': 'Сожмите несколько коммитов в один'},
{'en': 'cherry-pick', 'ru': 'выборочно применять коммит', 'example_en': 'Cherry-pick the bugfix commit', 'example_ru': 'Выборочно примените коммит с исправлением'},
{'en': 'blame', 'ru': 'показать авторство строк', 'example_en': 'Use blame to see who wrote each line', 'example_ru': 'Используйте blame, чтобы увидеть автора каждой строки'},
{'en': 'ignore', 'ru': 'игнорировать', 'example_en': 'Add the file to gitignore', 'example_ru': 'Добавьте файл в gitignore'},
{'en': 'init', 'ru': 'инициализировать', 'example_en': 'Init a new Git repository', 'example_ru': 'Инициализируйте новый Git-репозиторий'},
{'en': 'config', 'ru': 'конфигурация, настройка', 'example_en': 'Set your config for username', 'example_ru': 'Установите конфигурацию для имени пользователя'},
{'en': 'global', 'ru': 'глобальный', 'example_en': 'Set global settings for all repositories', 'example_ru': 'Установите глобальные настройки для всех репозиториев'},
{'en': 'local', 'ru': 'локальный', 'example_en': 'Local settings override global ones', 'example_ru': 'Локальные настройки переопределяют глобальные'},
{'en': 'workflow', 'ru': 'рабочий процесс', 'example_en': 'Follow the team workflow for commits', 'example_ru': 'Следуйте рабочему процессу команды для коммитов'},
{'en': 'hash', 'ru': 'хеш, контрольная сумма', 'example_en': 'Each commit has a unique hash', 'example_ru': 'Каждый коммит имеет уникальный хеш'},
{'en': 'amend', 'ru': 'исправлять, дополнять', 'example_en': 'Amend the last commit message', 'example_ru': 'Исправьте сообщение последнего коммита'},
{'en': 'verbose', 'ru': 'подробный', 'example_en': 'Use verbose mode for more details', 'example_ru': 'Используйте подробный режим для деталей'},
{'en': 'recursive', 'ru': 'рекурсивный', 'example_en': 'Clone with recursive submodules', 'example_ru': 'Клонируйте с рекурсивными подмодулями'},
{'en': 'submodule', 'ru': 'подмодуль', 'example_en': 'Add a submodule to your project', 'example_ru': 'Добавьте подмодуль в ваш проект'},
{'en': 'hook', 'ru': 'хук, перехватчик', 'example_en': 'Create a pre-commit hook for linting', 'example_ru': 'Создайте хук pre-commit для линтинга'},
{'en': 'bisect', 'ru': 'делить пополам, искать методом деления', 'example_en': 'Use bisect to find the buggy commit', 'example_ru': 'Используйте bisect для поиска коммита с багом'},
...
🏆 <b>Система уровней:</b>
🌱 Новичок: 0-50 терминов
🥉 Изучающий: 50-120 терминов
🥈 Продвинутый: 120-200 термина
🏆 Эксперт: 200+ терминов
